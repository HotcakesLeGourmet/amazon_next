   ...
   return (
      <div className="flex flex-col gap-4">
         <div className="flex gap-2">
            ...
            <p className="text-sm">Your order qualifues for FREE Shipping</p>
         </div>
         ...
         {userInfo ?
            (<div className="flex flex-col items-center">
               ...
               onClick={handleCheckout}
                  className="w-full h-10 text-sm font-semibold bg-amazon_blue hover:bg-green-500 text-white rounded-lg ">
                  Proceed to Buy
               </button>
            </div>
            ) : (<div className="flex flex-col items-center">
               ...
               <p className="text-xs mt-1 text-red-500 font-semibold animate-bounce duration-300">Please login to continue</p>
            </div>)}
